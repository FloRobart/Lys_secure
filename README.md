...
- [Gestionnaire de compte](#gestionnaire-de-compte)
  ...
  - [Images](#images)
    ...
    - [Format ordinateur](#format-ordinateur)
      - [Page du Lys secure en format desktop](#page-du-lys-secure-en-format-desktop)
  - [Technologies utilisées](#technologies-utilisées)
  - [Installation](#installation)
    - [Prérequis](#prérequis)
    - [Installation de Lys secure](#installation-de-lys-secure)
    - [Lancer Lys secure](#lancer-lys-secure)
  - [Autheur](#autheur)
...
#### Page du Lys secure en format desktop
...
- Vous pouvez maintenant accéder à l'application à l'adresse `http://<IP Serveur>:2000` (remplacer `<IP Serveur>` par l'adresse IP de votre serveur sur lequel vous avez installé **Lys secure**).
  - Notez qu'en suivant ces instructions, vous aurez accès à **Lys secure** uniquement si vous êtes connecté au même réseau que votre serveur. Si vous voulez accéder à **Lys secure** depuis un autre réseau, vous devrez configurer votre serveur pour qu'il soit accessible depuis l'extérieur. Mais **ATTENTION** je ne recommande pas de le faire si vous n'avez pas les compétences, car cela peut poser des problèmes de sécurité.

## Autheur

Lys secure est un projet open-source développé seulement par [Floris Robart](https://florobart.github.io/)
